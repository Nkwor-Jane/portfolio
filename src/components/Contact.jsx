...
const Contact = () => {
  return (
    ...
    <div className="block sm:flex m-4 sm:m-8 justify-between" id='contact'>
      ...
      {/* FORM */}
    <div className=" flex items-center justify-center shadow-lg bg-slate-500/30 p-4 w-full sm:w-1/2 mb-3">
      <form className="  ">
        ...
        <button
          type="submit"
          className="border-2 rounded-full bg-gradient-to-r from-teal-400 to-blue-500 hover:from-pink-500 hover:to-orange-500  text-white font-bold py-2 px-6 cursor-pointer"
        >
          Submit
        </button>
      </form>
    ...
    <div className='flex gap-6 pt-4 items-center justify-center text-white pb-3'>
          <a href="https://github.com/Nkwor-Jane">
          <FaGithubSquare
          size={30}/>
          </a>
         <a href="https://www.linkedin.com/in/nkwor-jane/"><FaLinkedin size={30}/></a>
          <a href="https://x.com/gifted_jane" ><FaTwitter size={30}/></a>
